...
set_target_properties(cblite PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/lib/libcblite.3.1.0.dylib"
  IMPORTED_SONAME_MINSIZEREL "@rpath/libcblite.3.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS cblite )
list(APPEND _IMPORT_CHECK_FILES_FOR_cblite "${_IMPORT_PREFIX}/lib/libcblite.3.1.0.dylib" )
